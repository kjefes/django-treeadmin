...
class ChangeList(main.ChangeList):
    ...
    def get_queryset(self, *args, **kwargs):
        ...
        return super(ChangeList, self).get_queryset(*args, **kwargs).order_by(mptt_opts.tree_id_attr, mptt_opts.left_attr)
    ...
    def get_results(self, request):
        ...
        label = opts.app_label + '.' + ("change" in opts.permissions and "change" or "")
...
class TreeAdmin(admin.ModelAdmin):
    ...
    def has_change_permission(self, request, obj=None):
        ...
        if self.enable_object_permissions:
            opts = self.opts
            r = request.user.has_perm(opts.app_label + '.' + ("change" in opts.permissions and "change" or ""), obj)
        else:
            r = True
    ...
    def has_delete_permission(self, request, obj=None):
        ...
        if self.enable_object_permissions:
            opts = self.opts
            r = request.user.has_perm(opts.app_label + '.' + ("delete" in opts.permissions and "delete" or ""), obj)
        else:
            r = True
